...
export const NON_DEALER_TSUMO: Record<number, Record<number, [number, number]>> = {
  ...
  3: { 20: [700, 1300], 25: [800, 1600], 30: [1000, 2000], 40: [1300, 2600], 50: [1600, 3200], 60: [2000, 4000], 70: [2000, 4000], 80: [2000, 4000], 90: [2000, 4000], 100: [2000, 4000], 110: [2000, 4000] },
  4: { 20: [1300, 2600], 25: [1600, 3200], 30: [2000, 4000], 40: [2000, 4000], 50: [2000, 4000], 60: [2000, 4000], 70: [2000, 4000], 80: [2000, 4000], 90: [2000, 4000], 100: [2000, 4000], 110: [2000, 4000] },
};
...
export const DEALER_TSUMO: Record<number, Record<number, number>> = {
  ...
  4: { 20: 2600, 25: 3200, 30: 4000, 40: 4000, 50: 4000, 60: 4000, 70: 4000, 80: 4000, 90: 4000, 100: 4000, 110: 4000 },
};
